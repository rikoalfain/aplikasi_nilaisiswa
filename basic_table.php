...
<html lang="en">
  <head>
    ...
    <title>Informassi Nilai Siwa Online</title>
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo">Informasi Nilai Siswa Online</span></a>
            <!--logo end-->
