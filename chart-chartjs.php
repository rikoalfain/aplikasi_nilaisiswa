...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="index.php" class="logo">Informasi Nilai Siswa Online</span></a>
            <!--logo end-->
              ...
              <ul class="sidebar-menu">                
                  <li class="active">
                      <a class="" href="index.php">
                          ...
                          <span>Natifications</span>
                      </a>
                  </li>
				  
                      <ul class="sub">
                          <li><a class="" href="form_component.php">Nama</a></li>                          
                 </ul>
                  </li>       
                  </li>
                  <li>
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-file-text-o"></i> Nama Siswa A-K</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Forms</li>
						<li><i class="fa fa-file-text-o"></i>Nama Siswa A-K</li>
					</ol>
				</div>
			</div>
              <div class="row">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal " method="get">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
                                          <p class="form-control-static">richopasker@gmail.com</p>
                                      </div>
                                  </div>
                              </form>
                          </div>
